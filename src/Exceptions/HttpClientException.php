...
final class HttpClientException extends \RuntimeException implements Exception
{
    ...
    {
        return new self('The endpoint you have tried to access does not exist. Check if the domain matches the domain you have configure on Mailtrap.', 404, $response);
    }
